...
#include "PM/Components/Combat/EnemyCombatComponent.h"
...
void APMEnemyCharacter::PossessedBy(AController* NewController)
{
...
void APMEnemyCharacter::InitEnemyStartUpData()
{
